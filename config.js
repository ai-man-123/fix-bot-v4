...
global.sig = 'https://instagram.com/aiman1_23' // ig
...
global.plinkaja = '00XXXXXXXXXX' //link aja
...
/*============== Github Thanks To ==============*/
global.namagithub = 'ai-man-123' // nama github lu
global.linkgithub = 'https://github.com/ai-man-123' // tarok link github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 lynx-V1 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘lynx-BOT-V1 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ lynx-BOT-V1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Aiman`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 lynx-BOT-V1  あ」'
